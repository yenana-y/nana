    ...
    <div class="bigBox">
        ...
        <div class="box">
            <div class="box1">
                ...
                <div class="inner">
                    <div class="desc">由法国权威报纸《世纪报》评选</div>
                    <div class="desc1">
                        <div class="left">3688阅读</div>
                        <div class="right">
                            <ul class="like">
                                <li>
                                    <img src="https://user.kongfz.com/data/member_pic/8176/11338176.jpg" alt="">
        ...
        <div class="box">
            <div class="box1">
                ...
                <div class="inner">
                    <div class="desc">好的文学可以照见时代精神</div>
                    <div class="desc1">
                        <div class="left">6200阅读</div>
                        <div class="right">
                            <ul class="like">
                                <li>
                                    <img src="https://user.kongfz.com/data/member_pic/8176/11338176.jpg" alt="">
                                ...
                                <li>
                                    <img src="https://user.kongfz.com/data/member_pic/2289/8172289.jpg" alt="">
                                </li>
                            </ul>
                            <div class="num">
                                <span>5人</span>
        ...
        <div class="box">
            <div class="box1">
                ...
                <div class="inner">
                    <div class="desc">不徐不疾，得之于手而应于心</div>
                    <div class="desc1">
                        <div class="left">5218阅读</div>
                        <div class="right">
                            <ul class="like">
                                <li>
                                    <img src="https://user.kongfz.com/data/member_pic/8176/11338176.jpg" alt="">
        ...
        <div class="box">
            <div class="box1">
                ...
                <div class="inner">
                    <div class="desc">交织的时间空间，交错的人生</div>
                    <div class="desc1">
                        <div class="left">2930阅读</div>
                        <div class="right">
                            <ul class="like">
                                <li>
                                    <img src="https://user.kongfz.com/data/member_pic/8176/11338176.jpg" alt="">
                                ...
                                <li>
                                    <img src="https://user.kongfz.com/data/member_pic/9052/10669052.jpg" alt="">
                                </li>
                            </ul>
                            <div class="num">
                                <span>15人</span>
...
.header .more-icon {
  ...
  width: 0.28rem;
  height: 0.28rem;
  background: url(data:image/png;base64,)
    no-repeat 50%;
  background-size: 100%;
  padding-top: 0.15rem;
}
...
.box .inner .desc1 .right .like li img {
  width: 0.2rem;
  height: 0.2rem;
}
.box .inner .desc1 .right .num {
  float: right;
  height: 0.24rem;
  font-size: 0.12rem;
  color: #262626;
...
.box .inner .desc1 .right .num span {
  margin-left: 0.16rem;
  margin-right: 0.04rem;
}
.box .inner .desc1 .right .num img {
  width: 0.2rem;
  height: 0.2rem;
}
.box .inner .desc1 .right .num img:nth-child(2) {
  display: block;
}
.box .inner .desc1 .right .num img:nth-child(3) {
  display: none;
}
.huan {
  width: 100%;
